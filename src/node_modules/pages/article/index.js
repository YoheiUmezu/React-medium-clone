...
const Article = (props) => {
    ...
    const [{response: fetchArticleResponse,
            ...
            isLoading: fetchArticleLoading }, doFetch] = useFetch(apiUrl)

    const [{response: deleteArticleResponse}, doDeleteArticle] = useFetch(apiUrl)

    const [currentUserState] = useContext(CurrentUserContext)

    const [isSucessfulDelete, setIsSucessfulDelete] = useState(false)
    ...
    useEffect(() => {
        ...
        setIsSucessfulDelete(true)
    }, [deleteArticleResponse])

    if(isSucessfulDelete){
        return <Redirect to="/" />
    }
